...
<tr bgcolor="#FFFF88">
<td colspan="4" align="left" style="color:red"><c:if test="${cart.voucherGiven}">You've got free $100 voucher</c:if></td>
<td colspan="3" align="right">
<b>Sub Total: <fmt:formatNumber value="${cart.subTotal}" pattern="$#,##0.00" /></b><br/>
<c:if test="${cart.discountApplicable}"> <span style="color:red">10% Discount</span><br/>
<b>Discounted Sub Total: <fmt:formatNumber value="${cart.discountedSubTotal}" pattern="$#,##0.00" /></b></c:if>
